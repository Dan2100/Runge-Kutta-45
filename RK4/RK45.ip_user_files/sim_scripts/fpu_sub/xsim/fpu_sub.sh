...
#
# Script generated by Vivado on Mon Mar 30 04:11:16 -0400 2026
...
#
# Usage        : fpu_sub.sh
#                fpu_sub.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpu_sub.sh [-rerun]
#                fpu_sub.sh [-reset_run]
#                fpu_sub.sh [-clean]
#                fpu_sub.sh [-reset_log]
#                fpu_sub.sh [-help]
#
...
# script info
echo -e "fpu_sub.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpu_sub.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L axi_utils_v2_0_11 -L xbip_pipe_v3_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_24 -L floating_point_v7_1_21 -L secureip -L xpm --snapshot fpu_sub xil_defaultlib.fpu_sub -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fpu_sub -key {Behavioral:sim_1:Functional:fpu_sub} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fpu_sub.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fpu_sub.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fpu_sub.sh [-help]\n\
Usage: fpu_sub.sh [-step]\n\
Usage: fpu_sub.sh [-lib_map_path]\n\
Usage: fpu_sub.sh [-rerun]\n\
Usage: fpu_sub.sh [-reset_run]\n\
Usage: fpu_sub.sh [-clean]\n\
Usage: fpu_sub.sh [-reset_log]\n\
Usage: fpu_sub.sh [-keep_index]\n\
Usage: fpu_sub.sh [-noclean_files]\n\n\
