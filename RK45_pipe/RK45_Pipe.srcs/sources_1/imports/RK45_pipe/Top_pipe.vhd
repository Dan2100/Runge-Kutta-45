...
--                 Safety margin       =   6 cycles
--               All other FSM logic and memory/control connections are
--               identical to Top.vhd.
--
...
--   Total                  = 460 cycles
---------------------------------------------------------------------------
constant COMPUTE_WAIT : integer := 460;
...
begin
    if rising_edge(clock) then
        case state is
            ...
            when S_COMPUTE =>
                -- Wait for pipelined RK45 to produce valid outputs
                sm_flush <= '0'; sm_write_en <= '0'; sm_init <= '0';
