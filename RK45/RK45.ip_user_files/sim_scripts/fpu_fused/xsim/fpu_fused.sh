...
#
# Script generated by Vivado on Fri Mar 27 21:49:05 -0400 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fpu_fused.sh
...
#
# Usage        : fpu_fused.sh
#                fpu_fused.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpu_fused.sh [-rerun]
#                fpu_fused.sh [-reset_run]
#                fpu_fused.sh [-clean]
#                fpu_fused.sh [-reset_log]
#                fpu_fused.sh [-help]
#
...
# script info
echo -e "fpu_fused.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpu_fused.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L axi_utils_v2_0_11 -L xbip_pipe_v3_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_24 -L floating_point_v7_1_21 -L secureip -L xpm --snapshot fpu_fused xil_defaultlib.fpu_fused -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fpu_fused -key {Behavioral:sim_1:Functional:fpu_fused} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_15 axi_utils_v2_0_11 xbip_pipe_v3_0_11 xbip_dsp48_wrapper_v3_0_7 mult_gen_v12_0_24 floating_point_v7_1_21)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fpu_fused.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fpu_fused.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fpu_fused.sh [-help]\n\
Usage: fpu_fused.sh [-step]\n\
Usage: fpu_fused.sh [-lib_map_path]\n\
Usage: fpu_fused.sh [-rerun]\n\
Usage: fpu_fused.sh [-reset_run]\n\
Usage: fpu_fused.sh [-clean]\n\
Usage: fpu_fused.sh [-reset_log]\n\
Usage: fpu_fused.sh [-keep_index]\n\
Usage: fpu_fused.sh [-noclean_files]\n\n\
