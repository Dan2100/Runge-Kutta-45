...
#                script (type 'fpu_fused.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/lehar/OneDrive/Documents/GitHub/Runge-Kutta-45/RK45/RK45.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
