...
#
# Script generated by Vivado on Mon Mar 30 22:53:01 -0400 2026
...
# script info
echo -e "Top_TB.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L axi_utils_v2_0_11 -L xbip_pipe_v3_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_24 -L floating_point_v7_1_21 -L secureip --snapshot Top_TB xil_defaultlib.Top_TB -log elaborate.log
}
...
Usage: Top_TB.sh [-rerun]\n\
Usage: Top_TB.sh [-reset_run]\n\
Usage: Top_TB.sh [-clean]\n\
