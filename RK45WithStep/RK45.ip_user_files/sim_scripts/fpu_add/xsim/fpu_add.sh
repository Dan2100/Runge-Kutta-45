...
#
# Script generated by Vivado on Fri Mar 27 21:48:46 -0400 2026
...
#
# Usage        : fpu_add.sh
#                fpu_add.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpu_add.sh [-rerun]
#                fpu_add.sh [-reset_run]
#                fpu_add.sh [-clean]
#                fpu_add.sh [-reset_log]
#                fpu_add.sh [-help]
#
...
# script info
echo -e "fpu_add.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpu_add.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L axi_utils_v2_0_11 -L xbip_pipe_v3_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_24 -L floating_point_v7_1_21 -L secureip -L xpm --snapshot fpu_add xil_defaultlib.fpu_add -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fpu_add -key {Behavioral:sim_1:Functional:fpu_add} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fpu_add.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fpu_add.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fpu_add.sh [-help]\n\
Usage: fpu_add.sh [-step]\n\
Usage: fpu_add.sh [-lib_map_path]\n\
Usage: fpu_add.sh [-rerun]\n\
Usage: fpu_add.sh [-reset_run]\n\
Usage: fpu_add.sh [-clean]\n\
Usage: fpu_add.sh [-reset_log]\n\
Usage: fpu_add.sh [-keep_index]\n\
Usage: fpu_add.sh [-noclean_files]\n\n\
