// =============================================================================
// Behavioral stub for Xilinx Floating Point v7.1 — Greater-Than Compare (Double)
// =============================================================================
...
module fp_gt_dp (
    ...
    localparam int LAT = `FP_CMP_LATENCY;

    logic [7:0] pipe_data  [0:LAT-1];
